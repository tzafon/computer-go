...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Computers.New(context.Background(), computer.ComputerNewParams{
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Computers.New(context.Background(), computer.ComputerNewParams{
		Kind: computer.String("browser"),
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Computers.New(cancelCtx, computer.ComputerNewParams{
		Kind: computer.String("browser"),
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Computers.New(deadlineCtx, computer.ComputerNewParams{
			Kind: computer.String("browser"),
		})
		if err == nil {
...
func TestContextDeadlineStreaming(t *testing.T) {
	...
	go func() {
		...
		stream := client.Agent.Tasks.StreamUpdatesStreaming(deadlineCtx, "task_id")
		for stream.Next() {
			_ = stream.Current()
		}
		if stream.Err() == nil {
...
func TestContextDeadlineStreamingWithRequestTimeout(t *testing.T) {
	...
	go func() {
		...
		stream := client.Agent.Tasks.StreamUpdatesStreaming(
			context.Background(),
			"task_id",
